...
export const metadata = buildPageMetadata({
  title: "Logolu Sipariş",
  description:
    "Logolu promosyon ürün siparişi için talep formu. Ürün, adet, baskı yeri ve logo dosyanız hakkında bilgi verin; üretim sürecini başlatalım.",
  path: "/logolu-siparis",
});

export default async function BrandedOrderPage() {
  ...
  return (
    <ShopChrome>
      <nav className="mb-4 flex flex-wrap items-center gap-1.5 text-[12px] text-[#8b919a]">
        ...
        <ChevronRight className="size-3" />
        <span className="text-[#555]">Logolu Sipariş</span>
      </nav>
      ...
      <div className="mx-auto max-w-2xl rounded-xl border border-[#eceff3] bg-white p-5 sm:p-7">
        ...
        <p className="mt-2 text-[14px] leading-relaxed text-[#6b7280]">
          Logolu üretim için ürün, adet, renk ve baskı yerini belirtin. Logo dosyanızı (tercihen vektör:
          AI, PDF, EPS) e-posta ile iletebilir veya mesaj alanında belirtebilirsiniz.
        </p>
        ...
        <ContactForm
          ...
          defaultSubject="Logolu sipariş talebi"
          bodyPlaceholder="Ürün/stok kodu, adet, renk, baskı yeri, logo dosyası bilgisi ve teslim notlarınız…"
        />
      </div>
    </ShopChrome>
  );
